...
import { useChangePassword } from "@/store/hooks/useChangePassword";

export default function ChangePassword() {
  const { form, isSubmitting, error, onSubmit } = useChangePassword();
  const {
    control,
    formState: { errors },
  } = form;
          ...
          <View className="mt-[15px]">
            <View className="w-full flex justify-center gap-[35px]">
              ...
              <View className="flex flex-row items-center justify-center gap-2">
                ...
                />
                <Link href="/profile">
                  <Text className="font-poppins-light text-[12px]">Back to profile</Text>
                </Link>
              </View>
            </View>
          </View>
